...
Begin VB.Form addparty 
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * FROM party"
      Caption         =   "Adodc1"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00C0C0C0&
      Caption         =   "Adding to Parties list"
      BeginProperty Font 
         Name            =   "Courier New"
         Size            =   14.25
         Charset         =   0
...
Adodc1.Recordset.AddNew "Party_id", 1
                       
End If
DataGrid1.Columns(0).Locked = True
DataGrid1.Columns(0).Caption = "Party ID"
DataGrid1.Columns(0).Width = 1400.189
DataGrid1.Columns(1).Caption = "Party Name"
