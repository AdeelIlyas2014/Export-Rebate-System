...
Begin VB.Form AddBanks 
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * FROM banks "
      Caption         =   "Adodc1"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
...
Adodc1.RecordSource = "select * from Banks"
Adodc1.Refresh
If Adodc1.Recordset.RecordCount = 0 Then
Adodc1.Recordset.AddNew "ID", 1
                       
End If
DataGrid1.Columns(0).Locked = True
DataGrid1.Columns(0).Caption = "Bank ID"
DataGrid1.Columns(0).Width = 1800.189
DataGrid1.Columns(1).Caption = "Bank Name"
DataGrid1.Columns(1).Width = 4000.236
DataGrid1.Columns(2).Caption = "Abbreviation"
DataGrid1.Columns(2).Width = 3000.236
DataGrid1.Columns(3).Caption = "Branch"
DataGrid1.Columns(3).Width = 6000.236
