...
Begin VB.Form Addcurrency 
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * FROM c_currency"
      Caption         =   "Adodc1"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00C0C0C0&
      Caption         =   "Adding to Currency list"
      BeginProperty Font 
         Name            =   "Courier New"
         Size            =   14.25
         Charset         =   0
...
i = Adodc1.Recordset!currency_id + 1
DataGrid1.Row = orows
...
Adodc1.RecordSource = "select * from c_currency"
Adodc1.Refresh
If Adodc1.Recordset.RecordCount = 0 Then
Adodc1.Recordset.AddNew "Currency_ID", 1
                       
End If
DataGrid1.Columns(0).Locked = True
DataGrid1.Columns(0).Caption = "Currency ID"
DataGrid1.Columns(0).Width = 1800.189
DataGrid1.Columns(1).Caption = "Currency Name"
DataGrid1.Columns(1).Width = 4000.236
DataGrid1.Columns(2).Caption = "Rupee Conversion"
DataGrid1.Columns(2).Width = 4000.236
End Sub
